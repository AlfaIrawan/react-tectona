...
import { Bot, Check, Loader2, Maximize2, Minimize2, Plus, Save, Search, X } from 'lucide-react'
                  ...
                  <div className="pr-3">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      {drawerFullscreen
                        ...
                        : 'Nama tampilan dipakai di pemilih asisten chat Tectona dan Advena. Korpus adalah satu-satunya sumber jawaban (bukan tool kredit atau SSD).'}
                    </p>
                  </div>
                  ...
                  <div className="min-h-0 min-w-0 flex-1 space-y-5 overflow-x-hidden overflow-y-auto px-5 py-5 scrollbar-hide">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        maxLength={120}
                        placeholder="Short and unique — mis. John — Penjelas MI Kredit"
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Textarea
                        ...
                        maxLength={500}
                        rows={4}
                        placeholder="Cakupan singkat: dokumen apa yang bisa dijelaskan (policy, MI, KS, …)"
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between gap-2">
                        <Label className="text-xs text-muted-foreground">Korpus</Label>
