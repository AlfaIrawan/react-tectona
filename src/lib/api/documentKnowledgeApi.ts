...
export type OnlyOfficeEditorConfig = {
  ...
  // The OnlyOffice DocEditor config (signed with a server-side JWT `token`). Passed verbatim to DocsAPI.
  config: Record<string, unknown>
}

/**
 * Fetch a signed OnlyOffice editor config for the document's latest attachment. The backend points
